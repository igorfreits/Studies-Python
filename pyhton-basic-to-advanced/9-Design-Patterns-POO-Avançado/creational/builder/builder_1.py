...
class User(StringReprMixin):
    def __init__(self):  # Padrão Gof, mas no Python não é preciso fazer isso
        self.firstname = None
        self.lastname = None
        self.age = None
        self.phone_number = []
...
if __name__ == "__main__":
    ...
    user_director = UserDirect(user_builder)

    user1 = user_director.with_age("John", "Doe", 30)
    user2 = user_director.with_address("John", "Doe", "Rua dos Bobos, 0")
