...
x = read.csv("Formação Cientista de Dados/5.Pratica em R/dados/Credit.csv", header = TRUE, sep = ",")
x
```
Excel
```{r}
dados = read.xlsx("Credit.xlsx", sheet= 1)
dados = read.xlsx("Formação Cientista de Dados/5.Pratica em R/dados/Credit.xlsx",sheet= 1)
